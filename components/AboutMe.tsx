...
const AboutMe = () => {
  ...
  const background = dark ? "bg-slate-900/50 " : "text-slate-900 bg-white/60";
      ...
      (loading)
        ...
        : <div id="about-me" className={`flex justify-center items-center w-full h-screen text-white backdrop-blur-xl ${background} ts
          px-3 pt-11 sm:px-0 lg:pt-0 lg:pl-52 relative`}>
            ...
            <div className={`relative flex flex-col w-screen text-center p-4 sm:p-8 rounded-2xl justify-center items-center bg-slate-900/90
            bg-[url('https://cdn.pixabay.com/photo/2022/06/20/14/20/space-7273891_960_720.jpg')] bg-cover shadow-md shadow-black/70
